package com.example.app.controller;//package com.example.application.controller;
...
//
//        Function<String, Predicate<T>> filterFunction = s ->
//                e -> StringUtils.containsIgnoreCase(converter.toString(e), s);
//
...
//
//        Function<String, Predicate<T>> pointByPointFilterFunction = s -> e -> StringUtils.containsIgnoreCase(pointByPointConverter.toString(e), s);
//
