...
import com.example.cs195tennis.model.Record.WtaPlayerRecord;
...
public class WtaPlayer extends TableImpl<WtaPlayerRecord> {
    ...
    public final TableField<WtaPlayerRecord, String> FIRST_NAME = createField(DSL.name("name_first"), SQLDataType.VARCHAR(255), this, "");

    public final TableField<WtaPlayerRecord, String> LAST_NAME = createField(DSL.name("name_last"), SQLDataType.VARCHAR(255), this, "");
