...
public class MatchDao {
    ...
    private final String CREATE_TABLE_SHOT_TYPE = "shot types";

    private final String CREATE_TABLE_SHOT_DIRECTION = "shot direction";
    ...
    private static final String CREATE_TABLE_KEY_POINT_OUTCOME = "CREATE TABLE MATCH OVER VIEW"
            + "("
            + " ID match_id,"
