...
import static com.example.cs195tennis.Dao.Table.Tables.*;
import static com.example.cs195tennis.database.Tools.connection;
...
public class TestAtpPlayerAtpRank {
    ...
    public static void unwrap() {
        ...
        GroupField[] groupBy = { WTA_PLAYER.ID, WTA_PLAYER.FIRST_NAME, WTA_PLAYER.LAST_NAME };
...
//
    ...
    public static void testTableFieldsPlayer() {
        ...
        Tools.print(
                ctx()
                        .select(ATP_PLAYER.ID, ATP_PLAYER.FIRST_NAME, ATP_PLAYER.LAST_NAME)
                        .from(ATP_PLAYER)
...
//                .bulkAll()
                .commitAll()
                .loadRecords(rs)
                .fields(ATP_PLAYER.ID, ATP_PLAYER.FIRST_NAME, ATP_PLAYER.LAST_NAME)
                .execute();
