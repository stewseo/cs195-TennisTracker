    ...
    public static void main(String[] args) throws Exception {
        ...
        switch (verification) {
            case 1 -> {
                ...
                sakilaTests.writeResultsToTxt(query, m5Q1, "module5/module5_question1", "products", "categories", "my_guitar_shop");
            ...
            case 2 -> {
                ...
                sakilaTests.writeResultsToTxt(query, m5Q2, "module5/module5_question2", "addresses", "customers","my_guitar_shop");
            ...
            case 3 -> {
                ...
                sakilaTests.writeResultsToTxt(query, m5Q3,"module5/module5_question3", "customers", "addresses","my_guitar_shop");
            ...
            case 4 -> {
                ...
                sakilaTests.writeResultsToTxt(query, m5Q4 ,"module5/module5_question4", "categories", "products","my_guitar_shop");
            ...
            case 5 -> {
                ...
                sakilaTests.writeResultsToTxt(query, m5Q5, "module5/module5_question5","products", null,"my_guitar_shop");
            ...
            """;
                ...
                sakilaTests.writeResultsToTxt(query, m5Q6, "module5/module5_question6", "products", "categories","my_guitar_shop");
            }
            case 7 -> {
                String m5Q7 = """
            ...
            Sort the final result set by OrderDate.""";
                ...
                sakilaTests.writeResultsToTxt(query, m5Q7, "module5/module5_question7","orders", null,"my_guitar_shop");
            }
            case 15 -> {
                ...
                sakilaTests.writeResultsToTxt(query, sql, "joins/inner_join", "orders", "customers","my_guitar_shop");
                ...
                sakilaTests.writeResultsToTxt(query, sql, "joins/left_outer_join", "orders", "customers","my_guitar_shop");
                ...
                sakilaTests.writeResultsToTxt(query, sql, "joins/right_outer_join", "orders", "customers","my_guitar_shop");
            }
